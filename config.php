<?php
//网站全局配置
$config['openregister'] = 1; // 1 开放注册，0 关闭注册
//在这里配置你所需的参数(与CanPHP无关)
$config['ver']='1.2.2011.1020';//版本号,2011.0314表示发布日期

//网站全局配置结束
$config['base_url']='http://diancan.games.com/';
...
$config['DB_HOST']='192.168.1.250';//数据库主机，一般不需要修改
$config['DB_USER']='diancan';//数据库用户名
$config['DB_PWD']='diancan@ptah';//数据库密码
...
$config['TPL_TEMPLATE_SUFFIX']='.phtml';//模板后缀，一般不需要修改，一般不需要修改
